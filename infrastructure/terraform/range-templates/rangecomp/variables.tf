...
variable "vsphere_folder" {
  description = "vCenter folder path for template VMs (default: rangecomp)"
  type        = string
  default     = "rangecomp"
  # Folder syntax: range<name> (e.g., rangecomp, rangexdr, rangeplatform)
}
...
variable "users_network_subnet" {
  description = "Users network subnet - provided via tfvars/user/agent (Range Comp: 172.24.2.0/24)"
  type        = string
  # Range Comp: "172.24.2.0/24" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}

variable "services_network_subnet" {
  description = "Services network subnet - provided via tfvars/user/agent (Range Comp: 172.24.3.0/24)"
  type        = string
  # Range Comp: "172.24.3.0/24" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}

variable "infrastructure_network_subnet" {
  description = "Infrastructure network subnet - provided via tfvars/user/agent (Range Comp: 172.24.4.0/24)"
  type        = string
  # Range Comp: "172.24.4.0/24" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}

variable "users_network_gateway" {
  description = "Users network gateway IP - provided via tfvars/user/agent (Range Comp: 172.24.2.1)"
  type        = string
  # Range Comp: "172.24.2.1" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}

variable "services_network_gateway" {
  description = "Services network gateway IP - provided via tfvars/user/agent (Range Comp: 172.24.3.1)"
  type        = string
  # Range Comp: "172.24.3.1" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}

variable "infrastructure_network_gateway" {
  description = "Infrastructure network gateway IP - provided via tfvars/user/agent (Range Comp: 172.24.4.1)"
  type        = string
  # Range Comp: "172.24.4.1" (172.24.0.0/16 network assignment)
  # Must be provided via tfvars file or user input
}
